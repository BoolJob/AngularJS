...
/**
 * @ngdoc object
 * @name lbServices.LoginUsuarioService
 * @header lbServices.LoginUsuarioService
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `LoginUsuarioService` model.
 *
 * ## Example
 *
 * See
  ...
  module.factory(
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/LoginUsuarioService/:id",
          { 'id': '@id' },
          {
          }
        );
        ...
        /**
        * @ngdoc property
        * @name lbServices.LoginUsuarioService#modelName
        * @propertyOf lbServices.LoginUsuarioService
        * @description
        * The name of the model represented by this $resource,
        * i.e. `LoginUsuarioService`.
        */
        R.modelName = "LoginUsuarioService";
...
/**
 * @ngdoc object
 * @name lbServices.RegUsuarioService
 * @header lbServices.RegUsuarioService
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `RegUsuarioService` model.
 *
 * ## Example
 *
 * See
  ...
  module.factory(
    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        /**
        * @ngdoc property
        * @name lbServices.RegUsuarioService#modelName
        * @propertyOf lbServices.RegUsuarioService
        * @description
        * The name of the model represented by this $resource,
        * i.e. `RegUsuarioService`.
        */
        R.modelName = "RegUsuarioService";
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Usuarios/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Usuario#regUsuario
             ...
             */
            "regUsuario": {
              url: urlBase + "/Usuarios/regUsuario",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Usuario#loginUsuario
             * @methodOf lbServices.Usuario
             *
             * @description
             *
             ...
             */
            "loginUsuario": {
              url: urlBase + "/Usuarios/loginUsuario",
              method: "POST",
            },
          }
        );
